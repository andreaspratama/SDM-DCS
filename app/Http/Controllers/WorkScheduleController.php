    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(
            function () use ($validated) {
                ...
                // Cari hari kerja pertama untuk
                // sinkron kolom lama jam_masuk/jam_pulang
                $firstWorkday =
                ...
                $workSchedule->jam_masuk =
                    $firstWorkday['jam_masuk']
                    ?? null;

                $workSchedule->jam_pulang =
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Template jadwal kerja berhasil ditambahkan.'
            );
    }
